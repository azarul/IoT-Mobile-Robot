...
//            client.println();
            ...
            if (request.indexOf("/5/on") >= 0) {
              ...
              stopState = "off";
              backwardState = "off";
            } else if (request.indexOf("/5/off") >= 0) {
              ...
              stopState = "off";
              backwardState = "off";
            } else if (request.indexOf("/4/on") >= 0) {
              ...
              stopState = "off";
              backwardState = "on";
            } else if (request.indexOf("/4/off") >= 0) {
              ...
              stopState = "off";
              backwardState = "off";
            } else if (request.indexOf("/16/on") >= 0) {
              ...
              stopState = "off";
              backwardState = "off";
            } else if (request.indexOf("/16/off") >= 0) {
              ...
              stopState = "off";
              backwardState = "off";
            } else if (request.indexOf("/14/on") >= 0) {
            ...
            } else if (request.indexOf("/14/off") >= 0) {
              ...
              stopState = "off";
              backwardState = "off";
            } else if (request.indexOf("/12/on") >= 0) {
              ...
              stopState = "on";
              backwardState = "off";
            } else if (request.indexOf("/12/off") >= 0) {
